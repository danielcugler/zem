...
.controller('registrarChamado4MenuCtrl', function($scope, $cordovaGeolocation, $state, $window, $ionicPlatform, MobileFactory, UnsolvedCallService, $ionicPopup, $ionicLoading) {
    ...
    $ionicPlatform.ready(function() {
        ...
        $scope.informarEndereco = function(){
