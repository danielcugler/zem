angular.module('app.controllers')
    ...
    .controller('configurationCtrl', function ($scope, MobileFactory, $ionicPopup) {
        ...
        $scope.buttonHelp = function () {
            $ionicPopup.alert({
                title: 'Informações',
                template: 'Aqui você pode configurar o aplicativo de forma a adequá-lo às suas necessidades. Além de alterar sua senha, você consegue nos dizer se está interessado em receber apenas mensagens emergenciais, ou todos os tipos de comunicados enviados pela prefeitura.',
                okType: 'button-zem'
            });
        }
    });
