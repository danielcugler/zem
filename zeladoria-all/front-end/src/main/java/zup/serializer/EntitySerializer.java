    ...
    public void serialize(Entity value, JsonGenerator jgen, SerializerProvider provider) 
      throws IOException, JsonProcessingException {
        jgen.writeStartObject();
        	...
        	jgen.writeObjectFieldStart("attendanceTime");
                	jgen.writeNumberField("highPriorityTime", value.getAttendanceTime().getHighPriorityTime());
        			jgen.writeNumberField("mediumPriorityTime", value.getAttendanceTime().getMediumPriorityTime());
        			jgen.writeNumberField("lowPriorityTime", value.getAttendanceTime().getLowPriorityTime());
        	jgen.writeEndObject();
 /*       			
       		jgen.writeFieldName("entityCategoryCollection");
