...
<body class="fixed-left full-content">
		...
		<div class="md-content">
			...
			<div>
				...
				<p class="text-center">
					...
					<a href="login.jsp" class="btn btn-success md-close">Yeah, I'm
						sure</a>
				</p>
			</div>
		</div>
	...
	<div class="container">
		<div class="full-content-center animated flipInX">
			...
			<br>
			<p class="text-lightblue-2">Que tal tentar de novo?</p>
			<div class="row">
			...
			<br> <a class="btn btn-primary btn-sm" href="index.jsp"><i
				class="fa fa-angle-left"></i> Voltar para a Dashboard</a>
		</div>
	</div>
	<!-- End of page -->
