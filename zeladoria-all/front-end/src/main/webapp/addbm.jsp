...
<title>Inclusão de Comunicado em Massa |</title>
<meta name="viewport"
...
<body class="fixed-left">
		...
		<div class="content-page">
			...
			<div id="generalModule" class="content">
				...
				<div class="page-heading">
					<h1>
						<i class='fa fa-table'></i> Comunicado em Massa
					</h1>
				</div>
				<!-- Page Heading End-->
						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-header transparent">
									<h2 id="title2">
										Inclusão de <strong>Comunicado em Massa</strong>
									</h2>
								</div>
										...
										<div class="row">
											<div class="col-md-12">
												<form id="IForm" method="get"
													...
													<div class="col-md-12" id="camposI">
														...
														<input type="text" class="form-control hideID" id="inId"
															...
															name="inEnabled" value="0">

														<div class="col-md-12 espacamento-left espacamento-right">
															<label>Assunto <span class="vermelho">*</span></label>
															<div class="form-group">
																<input type="text" class="form-control" id="inSubject"
														...
														<div class="col-md-12 espacamento-left espacamento-right">
															<div class="col-md-6 espacamento-left">
																<label>Categoria <span class="vermelho">*</span></label>
																<div class="form-group">
																	<select class="form-control selectBroadcastMessage"
																		name="selectBroadcastMessageCategory"
																		id="selectBroadcastMessageCategory"></select>
																</div>
															</div>
															<div class="col-md-6 combo espacamento-right"
																id="comboExpirationDate">
																<label>Validade <span class="vermelho">*</span></label><br>
																<div class='form-group'>
																	<select class="form-control selectExpirationDate"
																		id="selectExpirationDate" name="selectExpirationDate">
														...
														<div class="col-md-12 espacamento-left espacamento-right">
															...
															<label>Expira em (caso seja publicado hoje)</label>
															<div class="form-group">
														...
														<label>Corpo do Comunicado <span class="vermelho">*</span></label></label>

														<div class="form-group">
															<textarea id="inMessageBody" rows="12" cols="60"
													...
													<div class="col-md-12 buttonModule" align="center"
														...
														<a class="btn btn-success tamanho-botao" role="button"
															...
															id="btEdit">Salvar</a> 
  												<sec:authorize access="hasRole('ROLE_COMMUNICATION_PUBLISH')">
  												<a class="btn btn-blue-3"
															role="button" type="button" id="btSaveSendAdd">Salvar
															e publicar</a> 
															<a class="btn btn-blue-3" role="button"
															type="button" id="btSaveSendEdit" style="display: none;">Salvar
															e publicar</a> 
											</sec:authorize>
															
															<a href="broadcastmessage.jsp"
	...
	<script id="bmc-combo-template" type="text/x-handlebars-template">	
	...
	<div class='modal-footer'>
		<a href="../broadcastmessage.jsp"  style="display: none;" class='btn btn-success dbOk' role='button' id='bOk1'>Ok</a>
	...
	<script type="text/javascript" src="js/ctrlBMadd.js"></script>
