...
<title>Inclusão de Bairros |</title>
<meta name="viewport"
...
<body class="fixed-left">
						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-header transparent">
									<h2 id="title2">
										Inclusão de <strong>Bairros</strong>
									</h2>
								</div>
												...
												<form id="IForm" method="get"
													...
													<div id="fieldModule" class="col-md-12">
														<div id="camposI">
															...
															<input type="text" class="form-control hideID" id="inId" name="inId"/>
													...
													<div class="col-md-12 buttonModule" align="center"
														...
														<a class="btn btn-success tamanho-botao" role="button"
															...
															id="btEdit">Salvar</a> <a href="bairros.jsp"
	...
	<div class='modal-header'><button class='close' aria-hidden='true' data-dismiss='modal' type='button'>×</button> {{title}}
				...
				<a href="../bairros.jsp"  style="display: none;" class='btn btn-success dbOk' role='button' id='bOk1'>Ok</a>
...
&nbsp&nbsp&nbsp
		...
		<script type="text/javascript" src="js/ctrlNBadd.js"></script>
</body>
</html>