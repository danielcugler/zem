...
<title>Classificação de chamados |</title>
<meta name="viewport"
...
<body class="fixed-left">
		...
		<div class="content-page">
			...
			<div id="generalModule" class="content">
				...
				<div class="page-heading">
					<h1>
						<i class='fa fa-table'></i> Classificação de chamados
						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-header transparent">
									<h2>
										Consulta de <strong>Classificação de chamados</strong>
									</h2>
												...
												<form id="formMensagem"
													...
													<div class="col-md-12">
														...
														<div class="filter col-md-8 espacamento-left" id="campos">
															<div class="combo col-md-6 espacamento-left"
																id="comboName">
																<label>Nome</label><br> <select
																	class="form-control selectNome" id="selectName">
																</select>
															</div>
														<!-- 
															<div class="combo col-md-6 espacamento-right"
																id="comboSubject">
																<label>Requirimento de endereço</label><br> <select
																	class="form-control selectAddressRequiriment" id="selectAddressRequired">
																</select>
															</div>
															 -->
														</div>
														...
														<div id="botoes" class="col-md-12 espacamento-left">
															...
															<sec:authorize
																access="hasRole('ROLE_CALLCLASSIFICATION_CREATE')">
																<a href="../addmm.jsp"
											...
											<table id="table"
												...
												<thead id="cthead" class="thead">
													<tr>
														...
														<th class="paddingEsquerdo">Requerimento de endereço</th>
														<sec:authorize
															access="hasRole('ROLE_CALLCLASSIFICATION_UPDATE')">
	...
	<div class='modal-header'><button class='close' aria-hidden='true' data-dismiss='modal' type='button'>X</button> Ativar/Inativar o Modelo de Menssagem
				 </div>
	...
	<script type="text/javascript" src="js/ctrlCC.js"></script>
</body>
</html>