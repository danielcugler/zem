...
<body class="fixed-left">
						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-header transparent">
									<h2>
										Acompanhamento de <strong>Chamados</strong>
									</h2>
								</div>
											...
											<fieldset class="fieldset-space">
												...
												<div class="col-md-12">
													<form class="form-horizontal" id="search-call-form"
														...
														<div class="col-md-12" id="divEntity" style="padding-top: 10px;display:none;">
															<div class="form-group form-zero">
																<div class="col-md-4 combo espacamento-left"
																	id="comboEntity">
																	<div class=''>
																		<label>Entidade</label><br> <select
														...
														<div class="col-md-12" style="padding-top: 10px;">
															<div class="form-group form-zero">
																<div class="col-md-8 espacamento-left"
																...
																<div class="col-md-4 espacamento-right">
																	<fieldset>
																		...
																		<input type="radio" class="radio-button"
																			name="radio-status" id="atrasado" value="Atrasado" />
																		Atrasado <input class="radio-button" type="radio"
																			name="radio-status" value="EmDia" id="emdia" /> Em
																		dia <input class="radio-button" type="radio"
																			name="radio-status" value="" id="ambos"
									...
									<div id="tabela" class="table-responsive">
										<fieldset>
											...
											<table id="resultado" class="fixo table table-hover scrollTabela">
												<col width="3%" /> <!-- Seta de expansão -->
												<col width="5%" /> <!-- ID -->
												<col width="7%" /> <!-- Origem -->
												<col width="10%" /> <!-- Classificação -->
												<col width="12%" /> <!-- Aberto em -->
												<col width="12%" /> <!-- Expira em -->
												<col width="8%" /> <!-- Prioridade -->
												<col width="23%" /> <!-- Descrição -->
												<col width="10%" /> <!-- Mídia -->
												<col width="10%" /> <!-- Ações -->
												<thead id="cthead"> 
													<tr>
														...
														<th class="centerTabela">Origem</th>
														<th class="paddingEsquerdo">Classificação</th>
														<th class="paddingEsquerdo">Aberto em</th>
														<th class="paddingEsquerdo">Expira em</th>
	...
	<div class='modal-header'><button class='close' aria-hidden='true' data-dismiss='modal' type='button'>×</button> Comunicado em massa
				...
				<div class='modal-body'> Você tem certeza que deseja {{msg}} o chamdo {{idp}}?
				</div>
	...
	<script type="text/javascript" src="js/ctrlCF.js"></script>
	<script>
		$.getScript(
