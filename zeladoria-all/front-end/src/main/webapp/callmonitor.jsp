											...
											<table id="resultado"
												...
												<thead id="cthead">
													...
													<tr role="row">
														...
														<th class="sorter-false sorter-shortDate dateFormat-ddmmyyyy cursor filterTh"
															id="4" value="4">
															<div class="col-md-6">Data</div>
															<div id="orderdate" data-column="1"
																class="fa fa-sort sortId" align="right"></div>
														</th>
										    <!-- 	<sec:authorize access="hasRole('ROLE_CALL_UPDATE')"> -->
														<th class="sorter-false cursor filterTh" id="5" value="5">Prioridade
															<div class="btn-group">
																...
																<ul
																	...
																	multiple>
<!-- 																	<li class="espacamentoFiltros"><input type="checkbox" data-column="6" -->
											...
											<!-- 	</sec:authorize> -->
														...
														<th class="sorter-false cursor filterTh" id="7" value="7">Status
															<div class="btn-group">
																...
																<ul
																	class="dropdown-menu selectFilter tablesorter-filter search9 filter"
																	multiple>
																</ul>
															</div>
