...
<body class="fixed-left">
		...
		<div class="content-page">
			...
			<div id="generalModule" class="content">
				...
				<div class="page-heading">
					<h1>
						<i class='fa fa-table'></i> Alteração de Senha
						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-header transparent">
									<h2>
										Alterar minha <strong>senha</strong>
									</h2>
								</div>
								<div class="widget-content">
									<div class="data-table-toolbar">
										<div class="row">
											<div class="col-md-8">
												<form id="IForm" onkeypress="return event.keyCode != 13;">
													...
													<div class="form-group">
														<input type="password" class="form-control" id="oldPass"
															name="oldPass" maxlength="12">
													</div>
													<label>Nova Senha</label>
													<div class="form-group">
														<input type="password" class="form-control" id="newPass"
															name="newPass" maxlength="12">
													</div>
													<label>Confirmar Senha</label>
													<div class="form-group">
														<input type="password" class="form-control"
															id="confirmPass" name="confirmPass" maxlength="12">
													</div>
													<button type="button" class="btn btn-success cadastrar"
														id="save" value="submit">Salvar</button>
	...
	<div class='modal-header'><button class='close' aria-hidden='true' data-dismiss='modal'  type='button'>X</button> {{title}}
				...
				<a href="../index.jsp" class='btn btn-success' role='button' id='bOk1'>Ok</a>
				</div>
			</script>
	<script>
		var resizefunc = [];
	...
	<script type="text/javascript" src="js/ctrlPW.js"></script>
