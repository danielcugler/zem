...
<body class="fixed-left">
												...
												<div class="col-md-12">
													<form class="form-horizontal" id="search-citizen-form"
															...
															<div class="form-group form-zero">
																...
																<div class="col-md-6">
																	<label>E-mail</label> <input type="text"
																		class="form-control" id="inEmail" name="cEmail"
																		maxlength="100">
																</div>
															</div>
														</div>
														...
														<div id="botoes" class="col-md-12 espacamento-left">
															...
															<sec:authorize access="hasRole('ROLE_CITIZEN_CREATE')">
																<a href="../addmm.jsp"
										...
										<table id="table" class="fixo table table-hover">
											...
											<thead id="cthead">
												<tr>
													...
													<th class="centerTabela">Telefone</th>
	...
	<div class='modal-header'><button class='close' aria-hidden='true' data-dismiss='modal' type='button'>X</button> Ativar/Inativar o Cidadão
				 </div>
				<div class='modal-body'> Você tem certeza que deseja {{msg}} o Cidadão {{name}}?
				</div>
	...
	<script type="text/javascript" src="js/ctrlCT.js"></script>
</body>
</html>