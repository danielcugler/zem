							...
							<div class="widget">
								...
								<div class="widget-content">
									<div class="data-table-toolbar">
										<div class="row">
											<div class="col-md-12">
												<div class="col-md-4">Como o cidadão deseja se
													identificar?</div>
											</div>
											<div class="col-md-12" style="margin-top:10px;">
												<p>
													<button class="btn btn-success btn-lg" align="left"
														onclick="location.href='/usuarioweb.jsp'"
														style="width: 250px;">Fornecer dados</button>
													Se o cidadão deseja acompanhar seu chamado por e-mail
													 ou pelo mobile, clique em "Fornecer dados".
													</p>
											</div>
											<div class="col-md-12" style="margin-top:10px;">
												<p>
													<button class="btn btn-success btn-lg" align="left"
														onclick="location.href='/addinternalcall.jsp'"
														style="width: 250px;">Anônimo</button>

													Se o cidadão deseja apenas cadastrar o chamado sem se
													identificar ou acompanhá-lo, clique em "Anônimo".
												</p>
											</div>
										</div>
									</div>
