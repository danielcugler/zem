var ctrlNC = (function($, module) {
	...
	var $selectEntity = $formModule.find("#selectEN");
	var $selectEntityCategory = $formModule.find("#selectEC");
	...
	var citizen = null;
	// bind events
	//console.log(jQuery._data( ".foto", "events" ));
	//console.log(jQuery._data( ".file-input-wrapper", "events" ));
	//console.log(jQuery._data( "#upload3", "events" ));
	//$('.file-input-wrapper').off();
	...
	function resize(image){
		...
		img.src = image;
	      var canvas=document.createElement("canvas");
	        ...
	        var thumb=new Image();
	        var imgRes = canvas.toDataURL();
	        return imgRes.split(',')[1];
	}
