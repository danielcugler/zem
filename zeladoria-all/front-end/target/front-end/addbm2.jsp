...
<body class="fixed-left">
												...
												<form id="IForm" method="get">
													<div class="col-md-12" id="camposI">
														...
														<input type="text" class="form-control hideID"
															id="cEnabled" name="inEnabled"> <label>
															Assunto</label>
													...
													<div class="col-md-12 buttonModule" align="center"
														...
														<a class="btn btn-success tamanho-botao" role="button"
															...
															id="btEdit">Salvar</a> <a href="broadcastmessage.jsp"
	...
	<div class="col-md-6"> <label>Broadcast Message Category</label><br>
...
&nbsp&nbsp&nbsp
	...
	<script type="text/javascript" src="js/ctrlBMadd2.js"></script>
