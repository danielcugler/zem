...
<body class="fixed-left">
										...
										<div class="row">
											<div class="col-md-12">
												<form id="IForm" method="get" onkeypress="return event.keyCode != 13;">
													<div class="col-md-12" id="camposI">
														...
														<div class="form-group">
															<select class="form-control"
																id="comboBroadcastMessageCategory"
																name="comboBroadcastMessageCategory">
																<option>Selecione uma categria</option>
															</select>
														</div>
														...
														<div class="form-group">
															<textarea id="cMessageBody" rows="12" cols="60"
													...
													<div class="col-md-12" id="botoes" align="center">
														<a class="btn btn-success incluirAction tamanho-botao"
															role="button" type="button" id="saveButton">Salvar</a> <a
															class="btn btn-blue-3" role="button" type="button"
															id="publicButton">Salvar e Enviar</a> <a
															href="broadcastmessage.jsp"
	...
	<!--<script type="text/javascript" src="js/templatesBM.js"></script> -->
	<script type="text/javascript" src="js/template.js"></script>
	<script type="text/javascript" src="js/abstractCRUD.js"></script>
	<!--<script type="text/javascript" src="js/crudClienteBM.js"></script> -->
	<!--<script type="text/javascript" src="js/messagesBM.js"></script> -->
	<script type="text/javascript" src="js/cadastroBroadcast.js"></script>
