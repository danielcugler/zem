						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-header transparent">
									<h2 id="title2">
										Inclusão de <strong>Categoria de Entidade</strong>
									</h2>
								</div>
												...
												<form id="IForm" method="get"
														...
														<div class="col-md-12 espacamento-left">
															<div class="form-group">
																...
																<input type="hidden" class="form-control"
																	id="inEntityCategoryId" name="Id"> <input
																	type="hidden" class="form-control" id="inEnabled"
																	name="Enabled" value="0"> <input
																	type="checkbox" id="inSendMessage" name="envio">
													...
													<div class="col-md-12 buttonModule" align="center"
														...
														<a class="btn btn-success tamanho-botao" role="button"
															...
															id="btEdit">Salvar</a> <a href="entitycategory.jsp"
...
&nbsp&nbsp&nbsp
		...
		<script type="text/javascript" src="js/ctrlECadd.js"></script>
</body>
</html>