...
<body class="fixed-left">
												...
												<form id="IForm" method="get" onkeypress="return event.keyCode != 13;">
													<div class="col-md-12">
														<div id="camposI">
															...
															<input type="text" class="form-control hideID" id="CId"
																...
																class="form-control hideID" id="CEnabled"
																name="CEnabled">

															<div class="form-group">
																<label> Nome</label> <input type="text"
																	class="form-control" id="CName"
																	placeholder="Digite o nome." name="CName"
																	maxlength="100">
															</div>

															<div class="form-group">
																<label>Assunto</label> <input type="text"
																	class="form-control" id="CSubject"
													...
													<div class="col-md-12 buttonModule" align="center"
														...
														<a class="btn btn-success tamanho-botao" role="button"
															type="button" id="saveButton">Salvar</a> <a
															href="messagemodel2.jsp"
	...
	<script type="text/javascript" src="js/controllerMM2Add.js"></script>
