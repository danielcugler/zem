...
<title>Inclusão de Perfil |</title>
<meta name="viewport"
		...
		<div class="content-page">
			...
			<div id="generalModule" class="content">
				...
				<div class="page-heading">
					<h1>
						<i class='fa fa-table'></i> Perfil de Usuário
						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-header transparent">
									<h2 id="title2">
										Inclusão de <strong>Perfil de Usuário</strong>
									</h2>
								</div>
								<div class="widget-content">
									<div class="data-table-toolbar">
										<div id="fieldModule" class="row">
											<div class="col-md-12">
												<form id="form-cadastro-sup" method="get">
													<div class="col-md-12">
														<div class="form-group">
															<input type="hidden" id="username" name="username"
																value="<sec:authentication property='principal.username'/>" />

															<label>Nome <span class="vermelho">*</span></label></label> <input
																type="text" class="form-control" id="inName"
																name="inName" maxlength="100"> <input
																type="hidden" class="form-control" id="inId" name="inId">
															<input type="hidden" class="form-control" id="inEnabled"
																name="inEnabled"> <br>
														</div>
													</div>
													<div class="form-group">
														<div class="col-md-12">
															<label>Lista de permissões <span class="vermelho">*</span></label></label>
														</div>
														<div class="col-md-12" id="atencao"></div>
														<div class="col-md-12">
															<select align="center" multiple="multiple"
																id="selectSUPP" name="my-select[]"
																class="form-control multi-select" required>
											...
											<div class="col-md-12 buttonModule" align="center"
												...
												<a class="btn btn-success tamanho-botao" role="button"
													...
													id="btEdit">Salvar</a> <a href="sup.jsp"
...
<script id="select-error-template" type="text/x-handlebars-template">
<div class='modal-header'><button class='close' aria-hidden='true' data-dismiss='modal' type='button'>X</button>
	...
	<script type="text/javascript" src="js/ctrlSUPadd.js"></script>
