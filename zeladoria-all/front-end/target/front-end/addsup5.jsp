...
<body class="fixed-left">
						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-header transparent">
									<h2>
										Inclusão de <strong>Perfil</strong>
									</h2>
								</div>
								<div class="widget-content">
									<div class="data-table-toolbar">
										<div class="row">
											<div class="col-md-12">
												<form id="form-cadastro-sup" method="get" onkeypress="return event.keyCode != 13;">
													<div class="col-md-12">
														<div class="form-group">
															...
															<label>Nome</label> <input type="text"
																class="form-control" id="CName" name="nome"
																maxlength="100"> <input type="hidden"
																class="form-control" id="CId" name="Id"> <input
																type="hidden" class="form-control" id="CEnabled"
																name="Enabled"> <br>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-12">
															<select align="center" multiple="multiple" id="selectSUP"
																name="my-select[]" class="form-control multi-select">
											...
											<div class="col-md-12" align="center" id="botoes">
												<button type="button"
													class="btn btn-success cadastrar tamanho-botao"
													id="saveButton" value="saveButton">Salvar</button>
												<a class="btn btn-danger tamanho-botao" href="sup.jsp"
	...
	<script type="text/javascript" src="js/cadastrosup.js"></script>
