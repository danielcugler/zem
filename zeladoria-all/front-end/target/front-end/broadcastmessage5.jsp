...
<body class="fixed-left">
													...
													<form class="form-horizontal" id="search-broadcast-form"
															...
															<div class="form-group form-zero">
																<div class="col-md-4 espacamento-left">
																	...
																	<label>Assunto</label> <input type="text"
																		class="form-control" id="cSubject" name="cSubject"
																		maxlength="100">
																</div>
																<div class="col-md-4">
																	<fieldset>
																		...
																		<input type="radio" name="radio-category"
																			value="normal" id="normal" /> Normal <input
																			type="radio" name="radio-category" value="emergency"
																			id="emergency" /> Emergencial <input type="radio"
																			name="radio-category" value="both" checked="checked"
																			id="both" /> Ambos
																...
																<div class="col-md-4 espacamento-right">
																	<fieldset>
																		...
																		<input type="radio" name="radio-status"
																			value="enabled" id="enabled" /> Ativo <input
																			type="radio" name="radio-status" value="disabled"
																			id="disabled" /> Inativo <input type="radio"
																			name="radio-status" value="disabled" id="ambos"
																			checked="checked" /> Ambos
																	</fieldset>
																</div>
															</div>
														</div>
														...
														<div class="col-md-4 espacamento-left" id="botoes">
															...
															<sec:authorize
																...
																<a id="incluir" class="btn btn-success tamanho-botao"
	...
	<script type="text/javascript" src="js/controllerBM.js"></script>
	<script>
		$.getScript(
