...
<body class="fixed-left">
											...
											<fieldset class="fieldset-space">
												...
												<div class="col-md-12">
													<form class="form-horizontal" id="search-call-form"
														...
														<div class="col-md-12" style="padding-top: 10px;">
															<div class="form-group form-zero">
																<div class="col-md-8 espacamento-left" style="padding-top:30px;">
																...
																<div class="col-md-4 espacamento-right">
																	<fieldset>
																		...
																		<input type="radio" name="radio-status" id="atrasado"
																			value="Atrasado" /> Atrasado <input type="radio"
																			name="radio-status" value="Em dia" id="emdia" /> Em
																		dia <input type="radio" name="radio-status"
	...
	<script type="text/javascript" src="js/controllerCF.js"></script>
	<script>
		$.getScript(
