...
<body class="fixed-left">
							...
							<div class="widget">
								...
								<div class="widget-content">
									<div class="data-table-toolbar">
										<div class="row">
											<div class="col-md-8">
												<form id="fChangePass" onkeypress="return event.keyCode != 13;">
													...
													<div class="form-group">
														<input type="password" class="form-control"
															id="passconfirm" name="passconfirm" maxlength="12">
													</div>
	...
	<script type="text/javascript" src="js/controllerPassword.js"></script>
