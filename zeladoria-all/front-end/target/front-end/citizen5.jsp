...
<body class="fixed-left">
						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-header transparent">
									<h2>
										Consulta de <strong>Cidadãos</strong>
									</h2>
								</div>
									...
									<div class="data-table-toolbar">
										<div class="row">
											<fieldset class="fieldset-space">
												...
												<div class="col-md-12">
													<form class="form-horizontal" id="search-citizen-form"
														method="get">
															...
															<div class="form-group form-zero">
																...
																<div class="col-md-6">
																	<label>E-mail</label> <input type="text"
																		class="form-control" id="cEmail" name="cEmail"
																		maxlength="40">
																</div>
															</div>
														</div>
														...
														<div class="col-md-4 espacamento-left" id="botoes">
															<a class="btn btn-primary tamanho-botao" id="buscar" role="button"><i
	...
	<script type="text/javascript" src="js/controllerCD.js"></script>
