...
<body class="fixed-left">
							...
							<div class="widget">
								...
								<div class="widget-content">
									<div class="data-table-toolbar">
										<div class="row">
											<div id="detailedcitizen" class="col-md-12">
												<!-- 		
													<div class = "col-md-6">
														<h5><strong> Nome</strong></h5>
														<h5>Ana Claudia de Freitas Carvalho</h5>
														<br/>
														<h5><strong> E-mail</strong></h5>
														<h5>aninhaptc@hotmail.com</h5>
														<br/><h5><strong> Endereço</strong></h5>
														<h5>Rua: </h5><h5>Vinicius de Moraes</h5>
														<br/>
														<h5>Bairro: </h5><h5>Poetas</h5>
													</div>
													
													<div class = "col-md-6">
														<h5><strong> CPF</strong></h5>
														<h5>151.234.907-86</h5>
														<br/>
	...
	<script type="text/javascript" src="js/detailedcitizen.js"></script>
