...
<body class="fixed-left">
						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-header transparent">
									<h2>
										Edição do <strong>chamados</strong>
									</h2>
								</div>
												...
												<form id="IForm" method="get"
													...
													<div id="camposI">
														...
														<input type="text" class="form-control hideID" id="CId"
															...
															class="form-control hideID" id="CEnabled" name="CEnabled">
															...
															<div class="col-md-6 espacamento-left">
																<div class="col-md-6 espacamento-left">
																	...
																	<div class="form-group">
																		<input type="text" class="form-control" id="COrigem"
																			placeholder="Origem" name="COrigem" disabled>
																	</div>
																</div>
																<div class="col-md-6 espacamento-right">
																	...
																	<div class="form-group">
																		<input type="text" class="form-control" id="CDate"
																			placeholder="03/04/15" name="CDate" disabled>
																	</div>
																</div>
															</div>
															<div class="col-md-6 espacamento-right">
																...
																<div class="form-group">
																	<input type="text" class="form-control" id="CUser"
																		placeholder="X" name="CUser" disabled>
																</div>
																...
																<div class="form-group">
																	<div id="comboEntityCategory">
																		<label>Categoria de entidade <span
																			class="vermelho">*</span></label> <select
														...
														<div class="col-md-12">
															<div class="col-md-6 espacamento-left">
																<div class="form-group">
																	...
																	<div id="comboCallClassification"></div>
																</div>
															</div>
															<div class="col-md-6 espacamento-right">
																<div class="form-group">
																	<label>Prioridade <span class="vermelho">*</span></label>
																	<div id="comboPriority"></div>
																</div>
															</div>
														</div>
														<div class="col-md-12">
															...
															<div class="form-group">
																<textarea id="CDescription" rows="8" cols="40"
																	...
																	name="CDescription" maxlength="1000"></textarea>
															</div>
															<label id="CDescriptionId" class="hideID"></label>
														</div>
														<div class="col-md-12">
															...
															<label id="CCommentsId" class="hideID"></label>
														</div>
													...
													<div class="col-md-12" align="center" id="botoes">
														<a class="btn btn-success saveAction tamanho-botao"
															...
															type="button" id="saveSendButton">Salvar e Encaminhar</a>
														<a href="call.jsp" class="btn btn-danger tamanho-botao"
	...
	<script type="text/javascript" src="js/cadastroCall.js"></script>
</body>
</html>