...
<body class="fixed-left">
													...
													<div class="col-md-12  searchFilters">
															...
															<div id="campoEstado">
																...
																<fieldset>
																	...
																	<label> <input type="radio" id="enabled"
																		...
																		class="radio-button" name="radio-button" value="z"
																		checked> Ambos
																	</label>
																</fieldset>
															</div>
														...
														<div id="searchButtons" class="searchButtons">
															<div class="col-md-4 espacamento-left" id="botoes">
																...
																<button type="button"
																	class="btn btn-primary tamanho-botao search"
																	id="search">
																...
																<sec:authorize access="hasRole('ROLE_ENTITY_CREATE')">
																	...
																	<a href="http://localhost:8080/addEntity.jsp"
																		class="btn btn-success tamanho-botao add" id="add"
	...
	<div class='col-md-4'> <label>Assunto</label><br>
			...
			<option value="">Todas</option>{{#each jsonList}}
			<option value="{{subject}}"> {{subject}}</option>
			{{/each}}  </select></div>
	</script>

	<script id="edmodal-template" type="text/x-handlebars-template">
	<div class='modal-header'><button class='close' aria-hidden='true' data-dismiss='modal' type='button'>×</button> Ativar Entidade
				 </div>
				<div class='modal-body'> Você tem certeza que deseja ativar a Entidade {{name}}?
				</div>
	...
	<script type="text/javascript" src="js/controllerET3.js"></script>
