...
<title>Categorias de Entidades |</title>
<meta name="viewport"
									...
									<div class="data-table-toolbar">
										<div class="row">
											<fieldset class="fieldset-space">
												...
												<form id="search-person-form" method="get">
													<div class="col-md-12">
														...
														<div class="col-md-4 espacamento-left" id="botoes">
															...
															<sec:authorize
																...
																<a class="btn btn-success tamanho-botao" id="incluir"
																	role="button"><i class="fa fa-plus-circle"></i>
																	Incluir</a>
															</sec:authorize>
														</div>
													</div>
										...
										<div id="tabela" class="table-responsive">
											<table id="resultado"
												...
												<thead id="cthead">
													<tr>
														<th>Nome</th>
														<th>Envio de Respostas Diretas</th>
														<sec:authorize
															access="hasRole('ROLE_ENTITYCATEGORY_ENABLED') or hasRole('ROLE_ENTITYCATEGORY_UPDATE')">
															<th>Ações</th>
														</sec:authorize>
