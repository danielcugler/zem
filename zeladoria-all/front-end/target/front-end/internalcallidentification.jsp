...
<body class="fixed-left">
												...
												<form role="form" action="" method="post" class="login-form"
													...
													<div class="form-group">
														<label for="form-name">Nome</label> <input type="text"
															name="form-name" class="form-name form-control"
															id="cName" maxlength="100">
													</div>
													<div class="form-group">
														<label for="form-cpf">CPF</label> <input type="text"
															name="form-cpf" class="form-cpf form-control" id="cCpf">
													</div>
													<div class="form-group">
														<label for="form-email">E-mail</label> <input type="text"
															name="form-email" class="form-email form-control"
															id="cEmail" maxlength="100">
													</div>

													<button type="button" class="btn btn-success" id="save">Avançar</button>
	...
	<script type="text/javascript" src="js/webUser.js"></script>
