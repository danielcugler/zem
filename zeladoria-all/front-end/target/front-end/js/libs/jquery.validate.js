...
//validar SelectBox compoPerfil
jQuery.validator.addMethod('selectCheckPerfil', function (value) {
    return (value != '-1');
}, "Selecione o perfil");

//validar SelectBox compoEntidade
jQuery.validator.addMethod('selectCheckEntidade', function (value) {
    return (value != '-1');
