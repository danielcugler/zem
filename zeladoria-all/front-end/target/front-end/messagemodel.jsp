...
<body class="fixed-left">
													...
													<div class="col-md-12">
														...
														<div class="filter col-md-8 espacamento-left" id="campos">
															...
															<div class="combo col-md-6 espacamento-right"
																id="comboSubject">
																<label>Assunto</label><br> <select
																	class="form-control selectSubject" id="selectSubject">
																</select>
															</div>
														</div>
											...
											<table id="table"
												...
												<thead id="cthead" class="thead">
													<tr>
														...
														<th class="paddingEsquerdo">Corpo da Mensagem</th>
														<sec:authorize
															access="hasRole('ROLE_MESSAGEMODEL_ENABLE') or hasRole('ROLE_MESSAGEMODEL_UPDATE')">
	...
	<script type="text/javascript" src="js/ctrlMM.js"></script>
