										...
										<div class="row">
											<form id="IForm" method="get" class="form-horizontal">
												<div class="col-md-12" style="padding-top: 10px;">
													<div class="col-md-4" style="padding-top: 25px;">
														...
														<div class="col-md-4" style="padding-left: 0;">
															<input type="radio" name="radio-type" value="consolidado"
																id="consolidado" checked="checked" class="radio-button" />
															Consolidado
														</div>
														<div class="col-md-4" style="padding-left: 0;">
															<input type="radio" name="radio-type" value="relacionado"
																id="relacionado" class="radio-button" /> Relacionado
														</div>
													</div>
													<div class="col-md-4">
													...
													<div class="col-md-4 combo" id="comboCC">
														<label>Classificação </label> <select
															class="form-control selectCC" id="selectCC"
															name="selectCC">
												...
												<div class="col-md-12" style="padding-top: 10px;">
													<div class="col-md-4 combo" id="comboCS">
														<label>Origem </label> <select
															class="form-control selectCS" id="selectCS"
															name="selectCS">
															<option value="">Todas</option>
													...
													<div class="col-md-4 combo" id="comboCP">
														<label>Andamento </label> <select
															class="form-control selectCP" id="selectCP"
															name="selectCP">
															<option value="">Todas</option>
														</select>
													</div>
													<div class="col-md-4 combo" id="comboEN">
														<label>Entidade </label> <select
															class="form-control selectEN" id="selectEN"
															name="selectEN">
															<option value="">Todas</option>
														</select>
													</div>
												...
												<div class="col-md-12" style="padding-top: 10px;">
													<div class="col-md-4">
														<div class="combo" id="comboEC">
															<label>Categoria de Entidade </label> <select
																class="form-control selectEC" id="selectEC"
																name="selectEC" disabled>
																<option value="">Todas</option>
															</select>
														</div>
													</div>
													<div class="col-md-4 combo" id="comboPR">
														<label>Prioridade </label> <select
															class="form-control selectPR" id="selectPR"
															name="selectPR">
															<option value="">Todas</option>
													...
													<div class="col-md-4 combo" id="comboGR">
														<label>Gráfico </label> <select
															class="form-control selectGR" id="selectGR"
															name="selectGR">
												...
												<div class="col-md-12 row" style="padding-top: 10px; padding-bottom: 10px;"
													id="divCheck">
													<div id="errorReportFields" class="col-md-12">
														<div class="col-md-12">
															<div>
														...
														<div class="col-md-12">
															<div class="col-md-3">
																<input type="checkbox" class="check" id="selectAll"	
																	name="checkSelectAll" value="0" /> Marcar/Desmarcar Todos
															</div>
														</div>
														<div class="col-md-12" style="padding-top: 10px;"></div>
														<div class="col-md-12">
															<div class="col-md-3">
																<input type="checkbox" class="check check-report" id="data"
																	name="checkReportFields" value="0" /> Data
															</div>
															<div class="col-md-3">
																<input type="checkbox" class="check check-report" id="classificacao"
																	name="checkReportFields" value="1" /> Classificação
															</div>
															<div class="col-md-3">
																<input type="checkbox" class="check check-report" id="origem"
																	name="checkReportFields" value="2" /> Origem
															</div>
															<div class="col-md-3">
																<input type="checkbox" class="check check-report" id="entidade"
																	name="checkReportFields" value="3" /> Entidade
															</div>
														</div>
														<div class="col-md-12" style="padding-top: 10px;"></div>
														<div class="col-md-12">
															<div class="col-md-3">
																<input type="checkbox" class="check check-report" id="categoria"
																	name="checkReportFields" value="4" /> Categoria
															</div>
															<div class="col-md-3">
																<input type="checkbox" class="check check-report" id="andamento"
																	name="checkReportFields" value="5" /> Andamento
															</div>
															<div class="col-md-3">
																<input type="checkbox" class="check check-report" id="prioridade"
																	name="checkReportFields" value="6" /> Prioridade
															</div>
															<div class="col-md-3">
																<input type="checkbox" class="check check-report" id="bairro"
																	name="checkReportFields" value="7" /> Bairro
															</div>
														</div>	
														<div class="col-md-12" style="padding-top: 10px;"></div>
												...
												<div class="col-md-12" align="center" id="botoes">
													<button class="btn btn-success tamanho-botao" role="button"
														type="button" id="pdf">Gerar PDF</button>
													<button class="btn btn-info tamanho-botao" role="button"
														type="button" id="csv">Gerar CSV</button>
												</div>
...
<option value="">Selecione uma Entidade</option>
	...
	<script id="combo-cp-template" type="text/x-handlebars-template">
<option value="">Selecione o Andamento</option>
	...
	<script type="text/javascript" src="js/ctrlRT.js"></script>
	<script>
		$.getScript(
