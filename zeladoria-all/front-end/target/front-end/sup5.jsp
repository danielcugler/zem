...
<body class="fixed-left">
																...
																<div class="col-md-6 espacamento-right">
																	<fieldset>
																		...
																		<input type="radio" name="radio-button"
																			...
																			type="radio" name="radio-button" value="disabled"
																			id="disabled" /> Inativo <input type="radio"
																			name="radio-button" value="disabled" id="ambos"
	...
	<script type="text/javascript" src="js/controllerSUP.js"></script>
</body>
</html>