...
<body class="fixed-left">
														...
														<div class="col-md-8" style="padding-left: 0px;">
															<div class="form-group form-zero">
																...
																<div class="col-md-6">
																	...
																	<div id="comboPerfil">
																		<select class="form-control selectPerfil"
																			id="selectPerfil" name="selectCheckPerfil">
																		</select>
																	</div>
																</div>
															</div>
											...
											<table id="table" class="fixo table table-hover">
												...
												<thead id="cthead">
													...
													<tr>
														...
														<th class="paddingEsquerdo">E-mail</th>
														<th class="paddingEsquerdo">Perfil</th>
														<sec:authorize
															access="hasRole('ROLE_USER_ENABLE') or hasRole('ROLE_USER_UPDATE')">
	...
	<div class='modal-header'><button class='close' aria-hidden='true' data-dismiss='modal' type='button'>X</button>Ativar/Inativar o Usuário
				 </div>
				<div class='modal-body'> Você tem certeza que deseja {{msg}} o Usuário {{name}}?
				</div>
	...
	<script type="text/javascript" src="js/ctrlSU.js"></script>
