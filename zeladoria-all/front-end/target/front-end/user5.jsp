...
<body class="fixed-left">
						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-header transparent">
									<h2>
										Consulta de <strong>Usuários</strong>
									</h2>
								</div>
									...
									<div class="data-table-toolbar">
										<div class="row">
											<fieldset class="fieldset-space">
												...
												<div class="col-md-12">
													<form class="form-horizontal" id="search-user-form"
														method="get">
														<div class="col-md-8" style="padding-left: 0px;">
															<div class="form-group form-zero">
																<div class="col-md-6">
																	<label>Nome</label> <input type="text"
																		class="form-control" id="cNome" name="cNome"
																		maxlength="100">
																</div>
																<div class="col-md-6">
																	<label>Perfil</label><br>
																	<div id="comboPerfil"></div>
																</div>
															</div>
														</div>
														...
														<div class="col-md-4 espacamento-right">
															...
															<fieldset>
																...
																<input type="radio" name="radio-button" value="enabled"
																	id="enabled" /> Ativo <input type="radio"
																	name="radio-button" value="disabled" id="disabled" />
																Inativo <input type="radio" name="radio-button"
																	value="disabled" id="ambos" checked="checked" /> Ambos
															</fieldset>
														</div>
									...
									<div id="tabela" class="table-responsive">
										<fieldset>
											<table id="resultado" class="fixo table table-hover">
												...
												<col width="30%" />
												<sec:authorize
													access="hasRole('ROLE_USER_ENABLE') or hasRole('ROLE_USER_UPDATE')">
													<col width="5%" />
												</sec:authorize>
												<thead id="cthead">
	...
	<!--	<script type="text/javascript" src="js/crudClienteUS.js"></script> -->
	<script type="text/javascript" src="js/controllerUS.js"></script>
