						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-header transparent">
									<h2>
										Identificação de <strong>chamado</strong> interno
									</h2>
								</div>
										...
										<div class="row">
											<div class="col-md-6">
												<form role="form" action="" method="post" class="login-form"
													id="IForm" onkeypress="return event.keyCode != 13;">
													<div class="form-group">
														<label for="form-name">Nome</label> <input type="text"
															name="inName" class="form-name form-control"
															id="inName" maxlength="100">
													</div>
													<div class="form-group">
														<label for="form-cpf">CPF</label> <input type="text"
															name="inCpf" class="form-cpf form-control" id="inCpf">
													</div>
													<div class="form-group">
														<label for="form-email">E-mail</label> <input type="text"
															name="inEmail" class="form-email form-control"
															id="inEmail" maxlength="100">
													</div>

													<button type="button" class="btn btn-success" id="btAdd">Avançar</button>

													<a href="internalcall.jsp">
...
&nbsp&nbsp&nbsp
	...
	<script type="text/javascript" src="js/ctrlWU.js"></script>
