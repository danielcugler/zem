...
<title>IdentificaÁ„o do Usu·rio Mobile |</title>
<meta name="viewport"
						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-header transparent">
									<h2>
										Identifica√ß√£o de <strong>chamado</strong> interno
									</h2>
								</div>
										...
										<div class="row">
											<div class="col-md-6">
												<form role="form" action="" method="post" class="login-form"
													...
													<button type="button" class="btn btn-success" id="btAdd">Avan√ßar</button>
