...
public class SolvedCallSerializer extends JsonSerializer<SolvedCall> {
	
    @Override
    public void serialize(SolvedCall value, JsonGenerator jgen, SerializerProvider provider) 
      throws IOException, JsonProcessingException {
    	 DateFormat df = new SimpleDateFormat("dd/MM/yyyy");
    	jgen.writeStartObject();
        jgen.writeNumberField("unsolvedCallId", value.getSolvedCallId());
        if(value.getParentCallId()!=null){                    	  
        jgen.writeObjectFieldStart("parentCallId");
        jgen.writeNumberField("unsolvedCallId", value.getParentCallId().getSolvedCallId());
 ...
 //       jgen.writeObjectField("entityEntityCategoryMaps", value.getEntityEntityCategoryMaps());  
        ...
        jgen.writeNumberField("entityCategoryId", value.getEntityEntityCategoryMaps().getEntityCategory().getEntityCategoryId());
        ...
        jgen.writeNumberField("entityId", value.getEntityEntityCategoryMaps().getEntity().getEntityId());
